...
describe 'MockableHttpServer', () ->
    ...
    beforeEach () ->
        jasmine.getGlobal().setTimeout = (callback, time) ->
            callback()

        tested = new mockableHttpServer.MockableHttpServer
    ...
    it 'many clears', () ->
        tested.methodRoutesDelete() for i in [0..10]
        expect(tested.methodRoutesGet()).toEqual {}
    ...
    describe 'adds', () ->
        ...
        describe 'invalid entry', () ->
            it 'no path', () ->
                ...
                expect(() -> tested.methodRoutesPost(anEntry)).toThrow 'Invalid route data: no path or priority'

            it 'method is not any of GET/POST', () ->
                anEntry = {method: 'DELETE', path: 'aaa', priority: 1}
                expect(() -> tested.methodRoutesPost(anEntry)).toThrow 'Invalid route data: method must be POST or GET'

            it 'times is not a number', () ->
                anEntry = {method: 'GET', path: 'aaa', priority: 1, times: 'a'}
                expect(() -> tested.methodRoutesPost(anEntry)).toThrow 'Invalid route data: times must be a non-negative integer'
            ...
            it 'no action', () ->
                ...
                expect(() -> tested.methodRoutesPost(anEntry)).toThrow 'Invalid route data: no action provided'
            ...
            it 'response: no code', () ->
                ...
                expect(() -> tested.methodRoutesPost(anEntry)).toThrow 'Invalid route data: response must have code and body'
            ...
            it 'forward: no host', () ->
                ...
                expect(() -> tested.methodRoutesPost(anEntry)).toThrow 'Invalid route data: forward must have host and port'
        ...
        describe 'many routes', () ->
            ...
            it 'and deletes them', () ->
                while expected.length > 0
                    ...
                    expect(tested.methodRoutesGet()).toEqual expected
                    expect(() -> tested.methodRouteGet(nextKey)).toThrow
